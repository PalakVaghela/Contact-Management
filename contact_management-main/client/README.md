...
Admin can view all the regiestered users in the app in table format with checkbox admin can select users to create a team and team is shown with no. of user in it and Team can be created and Deleted by Admin only
